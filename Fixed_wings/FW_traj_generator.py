...
params = [
    ...
    0.05,       # [16] CD_alpha — induced drag slope 
    5.7,        # [17] CL_alpha — lift slope per rad 
    -0.8,       # [18] Cm_alpha — pitch stability derivative

    -0.1,       # [19] CY_beta — lateral force due to sideslip
    -0.1,       # [20] Cl_beta — roll moment from β 
     0.1,       # [21] Cn_beta — yaw moment from β 

    0.0,        # [22] CD_q — drag from pitch rate 
    0.0,        # [23] CL_q — lift from pitch rate 
   -2.0,        # [24] Cm_q — pitch damping 
   ...
   -1.0,        # [30] Cm_delta_e — elevator moment 
   ...
   -0.1,        # [33] Cn_delta_r — rudder yaw effectiveness
    ...
    8000,       # [34] omega (RPM max) 
    0.25,       # [35] propeller diameter (m) 
